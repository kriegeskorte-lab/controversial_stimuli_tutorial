...
def curlyBrace(fig, ax, p1, p2, k_r=0.1, bool_auto=True, str_text='', int_line_num=2, fontdict={}, nudge_label_x=0, nudge_label_y=0, **kwargs):
# def curlyBrace(fig, ax, p1, p2, k_r=0.1, bool_auto=True, str_text='', int_line_num=2, fontdict={}, **kwargs):
    ...
    **kwargs : matplotlib line setting arguments
    ...
    if str_text:
        ...
        ax.axes.text(arc2x[-1]+nudge_label_x, arc2y[-1]+nudge_label_y, str_text, ha='center', va='center', rotation=rotation, fontdict=fontdict)
